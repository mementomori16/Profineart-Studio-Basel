...
// ==========================================================
// THE FIX: ROUTER MOUNTING
// This keeps all your "/api/..." routes exactly as they are.
// ==========================================================
...
// Tell Express that our /api routes are mounted on the root
app.use("/api", router);

// Health check on the root
